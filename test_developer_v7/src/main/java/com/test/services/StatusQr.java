...
public class StatusQr {
	...
	private Logger log = LogManager.getLogger(StatusQr.class);
	
	public Map<String, Object> hitStatusQr(FlowVariables flowVars) {
		...
		try {
			// here can be input real process (ex. get data from database, get status from host, etc)
